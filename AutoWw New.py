...
class AutoWWMod(loader.Module): 
    ...
    async def watcher(self, message):
        ...
        responses = {
            ...
            "19 👣62км": ['⛺️Вернуться', 'Вернуться в лагерь'],
            "19 👣63км": ['⛺️Вернуться', 'Вернуться в лагерь'],
            "19 👣64км": ['⛺️Вернуться', 'Вернуться в лагерь'],
            ...
            "Ты можешь носить только 1 🧪Стимбласт+ с собой.": '🏘Нью-Рино',
            "Ты продал": None,  # No action needed, just a delay
            "🥖Взять булочку: 🕳80": '/eat2',
            "Ты сыт. Осторожнее с перееданием, здоровяк.": ['🏘Нью-Рино', '⬅️Назад', '🎓Обучение'],
            "Ты объелся и чувствуешь себя нехорошо.": ['🏘Нью-Рино', '⬅️Назад', '🎓Обучение'],
            "Ты съел Булочка.": '/eat2',
            "🚫 Недостаточно ресурсов!": ['🏘Нью-Рино', '👣Пустошь'],
