...
class AutoWWMod(loader.Module): 
    ...
    async def watcher(self, message):
        ...
        responses = {
            ...
            "21 👣22км": '🚷В Темную зону',
            "21 👣23км": '🚽Сточная труба',
            "21 👣30км": ['🏵Дзен', '/dzen', '👣Идти дaльше'],
            "21 👣37км": ['/use_101', '👣Идти дaльше'],
            "Ты очень голоден": ['/use_101', '👣Идти дaльше'],
            "21 👣45км": '🌁Высокий Хротгар',
            "22 👣51км": ['🛏Безопасный привал', '/deeprest'],
            "21 👣52км": '🚷В Темную зону',
            "21 👣70км": ['⛺️Вернуться', 'Вернуться в лагерь'],
            ...
            "Теперь ты стал немного опытнее.": '🗣Харизма',
            "Мудрый старец готов обучить тебя необходимым навыкам. Не бесплатно, разумеется. Крышечки тут всегда в ходу.": '🗣Харизма'
        }
